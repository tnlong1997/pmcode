define({ "api": [
  ...
  },
  {
    "type": "get",
    "url": "/protected",
    "title": "Get the protected route page",
    "version": "0.1.0",
    "name": "GetPrivateIndex",
    "group": "IndexPages",
    "permission": [
      {
        "name": "none"
    ...
    "filename": "pmserver/routes/protected.js",
    "groupTitle": "IndexPages"
  },
  {
    "type": "get",
  ...
  {
    "type": "put",
    "url": "/protected/users/:id/password",
    ...
    "description": "<p>Change password of current user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "pmserver/routes/users_protected.js",
    "groupTitle": "User"
  },
  {
    "type": "put",
    "url": "/protected/users/:id/profile",
    ...
    "description": "<p>Change profile of current user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>Delete current account.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    "type": "get",
    "url": "/protected/",
    "title": "Get the list of all user.",
    "version": "0.1.0",
    "name": "GetUserList",
    "group": "User",
    "permission": [
    ...
    "description": "<p>This will return the list of all users and can only be accessed by admin</p>",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    "type": "get",
    "url": "/protected/users/:id/profile",
    "title": "Get the profile of current user.",
    "version": "0.1.0",
    "name": "GetUserProfile",
    "group": "User",
    "permission": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "profile",
            "description": "<p>Profile of current user.</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "description": "<p>Login new user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "password",
            "description": "<p>Password for this account.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>New user's token.</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "InvalidInput",
            "description": "<p>Inputs for required field invalid.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "WrongPassword",
            "description": "<p>Input password incorrect.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "UserNotFound",
            "description": "<p>User cannot be found by database.</p>"
          }
        ]
      }
    },
    "filename": "pmserver/routes/users_public.js",
    "groupTitle": "User"
  },
  {
    "type": "post",
    ...
    "description": "<p>Sign up new user.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
